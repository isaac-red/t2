...
SELECT[AdventureWorks2019].[Sales].[SalesOrderDetail].[SalesOrderID]
	  ...
	  ()
		 ...
		 ,(2022 - [AdventureWorks2019].[Sales].[vStoreWithDemographics].[YearOpened]) AS store_trade duration
...
WHERE [AdventureWorks2019].[Sales].[vStoreWithDemographics].[BusinessEntityID] IS NOT NULL
